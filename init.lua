...
-- Some custom keymaps from my old Neovim setup! :)
...
vim.keymap.set("i", "<S-End>", "<Right><Esc>v$")
...
vim.keymap.set("n", "<C-x>", "<S-v>d")
vim.keymap.set("i", "<C-x>", "<Esc><S-v>d")
...
vim.keymap.set("v", "<Backspace>", "x")

vim.keymap.set("n", "<A-r>", ":%s/")
vim.keymap.set("n", "<A-a>", ":split | term<CR><S-a>")

vim.keymap.set("n", "<A-w>", "<C-w>w<S-a>")
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- Alternate keymap for fuzzily search in current buffer :)
